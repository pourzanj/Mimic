...
admissions_local <- admissions %>%
  ...
  mutate(age = (dob %--% admittime) %/% years(1),
         ...
         days_until_death =  (admittime %--% deathtime) %/% days(1)) %>%
  select(subject_id, hadm_id, ethnicity, gender, age, admittime, admission_type, diagnosis, admission_location, days_in_hosp, days_until_death)
